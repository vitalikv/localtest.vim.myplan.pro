...
$('[data-action="screenshot"]').mousedown(function () { saveAsImage(); }); 				





$('[data-action="deleteObj"]').mousedown(function () { detectDeleteObj(); });
$('[data-action="addPointCenterWall"]').mousedown(function () { addPointCenterWall(); });
