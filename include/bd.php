...
$infProject['settings']['api']['list_1'] = 'https://vim.myplan.pro/placer/api/ae/furniture/list';
$infProject['settings']['api']['list_2'] = 'https://vim.myplan.pro/placer/api/ae/lot.obj/list';
$infProject['settings']['api']['obj']['lot'] = 'https://vim.myplan.pro/placer/api/ae/lot.obj/';
$infProject['settings']['api']['obj']['model'] = 'https://vim.myplan.pro/models/';
