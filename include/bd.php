...
$infProject['settings']['api']['list'] = 'https://vim.myplan.pro/placer/api/ae/furniture/list';
$infProject['settings']['api']['models'] = 'https://vim.myplan.pro/models/';
...
$infProject['settings']['wall']['color']['top'] = 0xACACAC;
