...
$infProject['settings']['api']['list']['furn'] = 'https://vim2.myplan.pro/placer/api/ae/furniture/list/';
$infProject['settings']['api']['list']['wd'] = 'https://vim2.myplan.pro/placer/api/ae/lot.obj/list/';
$infProject['settings']['api']['inf']['item'] = 'https://vim2.myplan.pro/placer/api/ae/lot.obj/';
$infProject['settings']['api']['inf']['models'] = 'https://vim2.myplan.pro/models/';
$infProject['settings']['api']['type']['room'] = 'https://vim2.myplan.pro/placer/api/ae/room.zone/list';
