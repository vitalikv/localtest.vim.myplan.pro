...
$infProject['settings']['floor'] = [ 'o' => false, 'posY' => 0.0, 'height' => 0.01, 'changeY' => false, 'areaPoint' => 'center', 'material' => null ];
...
$infProject['settings']['api']['list'] = 'https://floe.ipsys.info/placer/api/ae/furniture/list';
$infProject['settings']['api']['models'] = 'https://floe.ipsys.info/models/';
$infProject['settings']['api']['type']['room'] = 'https://floe.ipsys.info/placer/api/ae/room.zone/list';
$infProject['settings']['html']['fonts']['wall']['size'] = 'font-size: 18px;';
$infProject['settings']['html']['fonts']['wall']['type'] = 'font-family: arial, sans-serif;';
$infProject['settings']['html']['fonts']['wall']['color'] = 'color: #3c3c3c;';
